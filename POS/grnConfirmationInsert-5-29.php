                ...
                if (isset($_SESSION['store_id'])) {
                    ...
                    foreach ($userLoginData as $userData) {
                        ...
                        if ($stock_result && $stock_result->num_rows > 0) {
                            ...
                            $conn->query("UPDATE stock2 SET stock_item_qty = '$update_qty' , stock_mu_qty = '$update_minimun_unit_qty' WHERE stock_item_code = '$product_code' AND stock_item_name = '$product_name' AND stock_item_cost = '$oneItemCost' AND stock_shop_id = '$shop_id'");
