                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-3">
                      <div class="card card-body bg-success">
                        ...
                        <?php $result = mysqli_fetch_assoc($conn->query("SELECT SUM(total_amount) AS total_amount FROM invoices WHERE DATE(`created`) = '$currentDate' AND shop_id='$shop_id' " )); ?>
                  ...
                  WHERE DATE(`invoiceDate`) = '$currentDate'");
                    ...
                    while ($invoiceItemQty_data = $invoiceItemQty_rs->fetch_assoc()) {
                      $stock_price_rs = $conn->query("SELECT * FROM stock2 WHERE stock2.stock_item_id = '" . $invoiceItemQty_data['code'] . "'  AND stock2.stock_shop_id='$shop_id'  ");
                    ...
                    ?>
                        <!-- <div class="col-md-3">
                          <div class="card card-body bg-primary">
                            <h2 class="text-white text-uppercase">Sell Profit</h2>
                            <p class="totalAmount"><?php echo $today_profit ?> LKR</p>
                          </div>
                        </div> -->
                    <?php
                      } else {
                    ...
                    <div class="col-md-3">
                      <div class="card card-body bg-danger">
                        ...
                        <?php $result = mysqli_fetch_assoc($conn->query("SELECT SUM(grn_sub_total) AS grn_sub_total FROM grn WHERE DATE(`grn_date`) = '$currentDate' AND grn_shop_id='$shop_id' ") ); ?>
