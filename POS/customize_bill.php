...
?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed" onload="focus_filed();">
        <div class="wrapper">
            ...
            <div class="content-wrapper bg-dark selectedShopPreview">
                <div class="row w-100">
                    <?php
                    $billpreview_rs = $conn->query("SELECT * FROM customize_bills WHERE `customize_bill_shop-id` = '1'");
                    $billpreview_data = $billpreview_rs->fetch_assoc();
                    ?>
                    <div class="col-12 col-md-8 bg-dark customize-bar-main">
                        <div class="col-12 cbTittleMain mb-2">
                            <h1>Customize Bill</h1>
                        </div>
                        ...
                        <div class="col-12">
                            <table class="w-100" id="sortable">
                                <thead></thead>
                                <?php
                                $position_rs = $conn->query("SELECT * FROM `customizable_data` ORDER BY `position` ASC");
