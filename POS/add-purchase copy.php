              ...
              <div class="row">
                ...
                <div class="col-12 p-4">
                  <div class="row">
                    ...
                    <div class="col-12 products-table mt-5" id="products-table">
                      <table class="table">
                        <thead>
                          <tr class="">
                            <th scope="col">#</th>
                        ...
                        <tbody id="filterBySupTable">
                          <div class="col-12 text-center blink" style="padding: 100px;">
                            <h3 class="text-danger text-uppercase">Select the supplier First !</h3>
                          </div>
                        </tbody>
                      </table>
                    </div>
