                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    WHERE   invoices.invoice_id = '" . $row['invoice_id'] . "' ";
                                                                ...
                                                                <td><?php echo number_format($row['paidAmount']); ?></td>
                                                                <td><?php echo number_format((float)$row['cardPaidAmount']); ?></td>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td colspan="2" class="text-right"><?php echo $result['total_amount']; ?> LKR</td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
