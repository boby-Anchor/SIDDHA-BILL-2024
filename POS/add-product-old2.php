                ...
                <div class="card-body">
                  ...
                  <div class="form-group ">
                    <div class="row"> 
                        ...
                        <div class="d-flex col-md-3">
                             <label for="name">From Abroad &nbsp; &nbsp;</label>
                        </div>
                    </div>    
                    <div class="row">   
                        <div class="d-flex col-md-4">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                        <div class="d-flex col-md-4">
                            <textarea class="form-control" rows="4" placeholder="Enter ..." name="details"></textarea>
                        </div>
                        <div class="d-flex col-md-3">
                        ...
                        <div class="d-flex col-md-4">
                            ...
                            <div class="row">
                            <div class="col-4">
                                <img id="img_preview" src="" alt="product image" height="150px" width="150px;" >
                            </div></div>
                        </div>
                    </div>
