                    ...
                    <div class="card card-default col-md-12 col-lg-9">
                        <div class="card-header py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h4 class="fs-17 font-weight-600 mb-0">Add New Stock</h4>
                                </div>
                                <div class="text-right">
                                    <a href="manage-products.php" class="btn btn-info btn-sm mr-1">Manage Stock</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            <select class="form-control select2" name="brand_product">
                                                ...
                                                if (isset($_SESSION['store_id'])) {
                                                    ...
                                                    foreach ($userLoginData as $userData) {
                                                        ...
                                                        $sql = $conn->query("SELECT * FROM producttoshop INNER JOIN p_medicine ON producttoshop.medicinId = p_medicine.id WHERE shop_id = '$shop_id'");
                                                        while ($row = mysqli_fetch_assoc($sql)) {
                                                ?>
                                                            <option class="text-capitalize" value="<?php echo $row['id']; ?>"><?= $row["name"] ?></option>
                                                <?php
                                                        }
                                                    }
                                                }
