    ...
    if ($sup_id != "0") {
        if (isset($_SESSION['store_id'])) {
            ...
            foreach ($userLoginData as $userData) {
                ...
                p_medicine.code AS product_code, p_brand.name AS brand, stock2.item_s_price AS item_price , stock2.stock_item_cost AS product_cost
                FROM p_medicine
    ...
    ?>
        ...
        if (isset($_SESSION['store_id'])) {
            ...
            foreach ($userLoginData as $userData) {
                ...
                stock2.item_s_price AS item_s_price, p_medicine.code AS product_code
                FROM producttoshop
