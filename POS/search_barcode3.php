                    ...
                    if ($type === "ip") {
                        ...
                        <tr data-barcode="<?= $barcodeData['code'] ?><?= $barcodeData['item_s_price'] ?>">
                            ...
                            <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-x-circle-fill text-danger" viewBox="0 0 16 16" onclick="removeRow(this)"
                            ...
                            <td>
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <input class="form-control text-center" id="qty" type="number" min="1" value="1"
                                                onchange="updateTotal(this)" data-price="<?= $barcodeData['unit_s_price'] ?>">
