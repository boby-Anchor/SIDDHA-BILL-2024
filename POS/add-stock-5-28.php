...
<body class="hold-transition sidebar-mini layout-fixed bg-dark">
    <div class="wrapper">
                                                ...
                                                <tbody id="filterBySupTable">
                                                    ...
                                                    if (isset($_SESSION['store_id'])) {
                                                        ...
                                                        foreach ($userLoginData as $userData) {
                                                            ...
                                                            $p_medicine_rs = $conn->query("SELECT p_medicine.id AS pid , p_medicine.name AS pname , `code` , p_medicine.img AS img , p_medicine_category.name AS categoryname , p_brand.name AS brandname ,  medicine_unit.unit AS unit , unit_category_variation.ucv_name FROM producttoshop
                                                            ...
                                                            WHERE 
                                                            shop_id='1' AND (producttoshop.productToShopStatus = 'added' OR producttoshop.productToShopStatus = 'all')");
        ...
        $orderId_rs = $conn->query("SELECT `AUTO_INCREMENT` FROM information_schema.tables WHERE table_schema = 'ceylriea_ts' AND table_name = 'stock2'");
    ...
    <script>
        $(document).ready(function() {
            ...
            // // Calculate discounted price old eka
    ...
    <script>
        $(document).off("click", ".confirmPObtn").on("click", ".confirmPObtn", function() {
            ...
            $("#grnConfirmationTableBody tr").each(function() {
                ...
                var cost_input = $(this).find(".cost_input").text(); //total amount
