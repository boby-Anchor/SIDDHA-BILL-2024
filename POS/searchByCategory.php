...
?>
        ...
        <div class="productTable">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                    $sql = $conn->query("SELECT * FROM p_medicine");
    ...
    ?>
        <div class="productTable">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                    $sql = $conn->query("SELECT * FROM p_medicine WHERE p_medicine.category = '$selectedCategoryId'");
                                            ...
                                            ?>
                                                    <div class="col-2 d-flex justify-content-center">
                                                        ...
                                                        ?>
                                                            ...
                                                            <input type="checkbox" id="shop<?= $shop_row['shopId'] ?><?= $medicine_id ?>" class="shop-checkbox selected-shop" checked>
                                                        <?php
                                                        } else if ($selected_shop_row["productToShopStatus"] == "remove") {
                                                        ?>
                                                            <input type="checkbox" id="shop<?= $shop_row['shopId'] ?><?= $medicine_id ?>" class="shop-checkbox">
