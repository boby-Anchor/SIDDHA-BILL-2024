          ...
          <div class="row">
            <div class="col-12">
              <div class="card bg-dark">
                ...
                <div class="row">
                  <div class="col-4">
                    <input type="text" class="form-control bg-dark" placeholder="Barcode Number" onkeyup="testFunction();" id="bnInput">
                  </div>
                  <div class="col-4">
                    <input type="text" class="form-control bg-dark" placeholder="Product Code" onkeyup="testFunction(this.value);" id="pcInput">
                  </div>
                  <div class="col-4">
                    <input type="text" class="form-control bg-dark" placeholder="Product Name" onkeyup="testFunction(this.value);" id="pnInput">
                  </div>
                  ...
                  <table id="stockTable" class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      if (isset($_SESSION['store_id'])) {
                        ...
                        foreach ($userLoginData as $userData) {
                          //   $shop_id = $userData['shop_id'];
                          //   $sql = $conn->query("SELECT stock2.stock_id, p_brand.name AS bName, p_medicine.img AS p_img , p_medicine.name AS p_name , stock2.stock_item_cost AS p_cost , stock2.stock_item_code AS p_code , stock2.stock_item_qty AS p_a_stock , stock2.item_s_price AS p_s_price , p_medicine_category.name AS p_category 
                          //   FROM stock2 
                          //   INNER JOIN p_medicine ON p_medicine.code = stock2.stock_item_code
