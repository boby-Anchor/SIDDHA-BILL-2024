                          ...
                          <tbody>
                            ...
                            ?>
                              <tr>
                                ...
                                <th>
                                  <?php
                                  $itemCount_result = $conn->query("SELECT COUNT(hub_order_id) AS itemCount , HO_date AS orderDate FROM hub_order WHERE HO_number = '" . $hub_order_details_data['hub_order_number'] . "'");
                                  ...
                                  <ul class="dropdown-menu">
                                    <table class="table" id="poItemsTable<?= $hub_order_details_data["hub_order_number"] ?>">
                                      ...
                                      <tbody>
                                        ...
                                        $poItems_result = $conn->query("SELECT * FROM hub_order INNER JOIN p_medicine ON p_medicine.id = hub_order.HO_item WHERE HO_number = '" . $hub_order_details_data['hub_order_number'] . "'");
